...
The intronic indel `16_56963437_C_CA` [VEP: intron_variant, MODIFIER impact, no coding change] cis-regulates *CETP* expression [OT L2G SHAP dominated by locus-architecture: `distanceSentinelFootprintNeighbourhood` 0.199, `distanceSentinelTssNeighbourhood` 0.124, `vepMaximumNeighbourhood` 0.124, `distanceTssMeanNeighbourhood` 0.104] → altered CETP dosage reshapes HDL/LDL particle composition and LXR-coupled cholesterol efflux [Reactome `R-HSA-8964058` HDL remodeling, `R-HSA-8964041` LDL remodeling, `R-HSA-8963899` Plasma lipoprotein remodeling, `R-HSA-9029569` NR1H3 & NR1H2 regulate cholesterol transport / efflux] → modulates lipid-rich drusen deposition at Bruch's membrane and the choroidal lipid milieu underlying AMD pathology [no DE rows in v0 indices for *CETP*; cell-type localization unresolved here] → AMD risk [`PMC4621603` reports *CETP* polymorphisms associated with AMD after CFH adjustment; `PMC7507364` ties rs5882 specifically to geographic-atrophy AMD]. Therapeutic-direction paradox to note: HDL-raising *CETP* alleles are cardioprotective but AMD risk-increasing — the retinal direction of effect is opposite to CVD precedent.
...
![CETP variant view](renders/CETP_P11597.png)
...
The CETP lead variant 16_56963437_C_CA is an intronic indel (most_severe_consequence: intron_variant, IMPACT: MODIFIER) with no coding change, so its effect is best framed as regulatory rather than structural — consistent with the high-confidence ESM3 fold of the 493-aa protein (mean pLDDT 0.853, pTM 0.780) being incidental rather than perturbed. The L2G score of 0.882 is driven almost entirely by locus-neighborhood positional features (distanceSentinelFootprintNeighbourhood SHAP 0.199, distanceSentinelTssNeighbourhood SHAP 0.124, vepMaximumNeighbourhood SHAP 0.124, distanceTssMeanNeighbourhood SHAP 0.104, e2gMeanNeighbourhood SHAP 0.089), meaning the call rests on proximity-to-TSS and regulatory-footprint evidence rather than coding consequence — a *cis*-regulatory tuning of *CETP* expression is the most parsimonious mechanism. No differential expression rows were returned for *CETP* in the available single-cell contrasts, so the cell-type compartment of the chain is unresolved and we cannot localize the effect to RPE, choroid, or a circulating myeloid pool from this evidence pack alone. Mechanistically, altered CETP dosage would propagate through the Reactome modules it belongs to — *HDL remodeling* (R-HSA-8964058), *LDL remodeling* (R-HSA-8964041), *Plasma lipoprotein remodeling* (R-HSA-8963899), and *NR1H3 & NR1H2 regulate gene expression linked to cholesterol transport and efflux* (R-HSA-9029569) — reshaping HDL/LDL particle composition and LXR-coupled cholesterol efflux, which plausibly modulates lipid-rich drusen deposition at Bruch's membrane and the choroidal lipid milieu underlying AMD pathology. Literature support is direct and convergent: PMC4621603 reports *CETP* polymorphisms significantly associated with AMD risk after CFH adjustment, and PMC7507364 specifically ties *CETP* rs5882 to atrophic (geographic-atrophy) AMD risk. Note the paradox flagged by the broader lipid-AMD literature: HDL-raising *CETP* alleles, generally cardioprotective, behave as AMD *risk* alleles, so the therapeutic vector for AMD is opposite that for cardiovascular disease and any CETP-directed intervention must be evaluated for retinal-specific direction of effect rather than borrowed from CVD precedent.
