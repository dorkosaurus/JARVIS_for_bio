...
Coding change at the ε-defining residue [VEP: missense C130R] → altered *APOE* isoform abundance and lipid-binding [pQTL coloc SHAP 0.164 / CLPP 0.97, H4 max 1.0 — OT L2G features] → dysregulated lipoprotein remodeling in highly *APOE*-expressing RPE [Reactome `R-HSA-8963898` Plasma lipoprotein assembly, `R-HSA-8963899` remodeling, `R-HSA-8964058` HDL remodeling; DE log₂FC +2.04 padj 5×10⁻⁵ in retinal pigment epithelial cells, Orozco LD et al. 2020 *Cell Rep* 30:1246] → impaired sub-RPE lipid clearance and drusen-driven AMD [`PMC8305051` Interactions between APOE Metabolism and Retinal Inflammation in AMD], with the killifish aging model [`bio_23d9ccbb77d9`] offering an in vivo system to test isoform-specific RPE lipid handling.
...
![APOE variant view](renders/APOE_P02649.png)

_ESM3 fold with variant C130R highlighted._  Source: PyMOL open-source headless render over ESM3 PDB.
...
The lead variant 19_44908684_T_C is a missense substitution at *APOE* residue 130 (C/R, the classical ε-isoform-defining site), called MODERATE impact but flagged "tolerated" by SIFT (score 1) — consistent with the well-known observation that this allele alters lipid-binding affinity rather than abolishing protein function, and the ESM3 fold (mean pLDDT 0.725, pTM 0.401, length 317) supports a locally ordered but globally flexible apolipoprotein consistent with its known helix-bundle architecture. The L2G call (score 0.961) is driven overwhelmingly by pQTL colocalization signal (pQtlColocClppMaximum SHAP 0.164, value 0.970; pQtlColocH4Maximum SHAP 0.090, value 1.0) plus tight sentinel-to-TSS/footprint proximity (both value 1.0), indicating the credible-set variant changes circulating/tissue APOE protein abundance in addition to its coding effect. *APOE* is markedly upregulated in retinal pigment epithelial cells (log2FC 2.04, padj 5e-5; Orozco et al. 2020 Cell Rep), the cell layer where lipid-rich sub-RPE drusen — the histologic hallmark of AMD — accumulate. Reactome places APOE squarely in Plasma lipoprotein assembly (R-HSA-8963898), Plasma lipoprotein remodeling (R-HSA-8963899), HDL remodeling (R-HSA-8964058), and Chylomicron clearance/assembly/remodeling (R-HSA-8964026/8963888/8963901), so an isoform that perturbs lipoprotein particle composition would plausibly impair RPE cholesterol efflux and seed drusen, with secondary engagement of complement and amyloid-beta as reviewed in PMC8305051 ("Interactions between Apolipoprotein E Metabolism and Retinal Inflammation in AMD"). Importantly, *APOE* biology in AMD is paradoxical relative to Alzheimer's: the ε4 allele that elevates AD risk is associated with *reduced* AMD risk while ε2 increases AMD risk (the shared-aetiology framing in PMC11029327 notwithstanding, and noting PMC3084239 found no APOE association in a Chinese cohort), so the directionality of effect at residue 130 must be interpreted isoform-aware rather than assumed loss-of-function. The coherent chain is therefore: coding change at the ε-defining residue → altered APOE isoform abundance/lipid-binding (pQTL-supported) → dysregulated lipoprotein remodeling in highly *APOE*-expressing RPE → impaired sub-RPE lipid clearance and drusen-driven AMD, with the killifish aging model (bio_23d9ccbb77d9) offering an in vivo system to test isoform-specific RPE lipid handling.
...
8. `jarvis-esm3.render_variant_png(P02649, …)` → `render_r130.png`
