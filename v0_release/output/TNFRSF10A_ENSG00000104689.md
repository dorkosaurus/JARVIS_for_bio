...
The `8_23225458_G_T` splice-region allele [VEP: splice_region_variant, MODIFIER impact] modulates *TNFRSF10A* transcript processing → shifts steady-state DR4 (TNFRSF10A) protein levels in chorioretinal tissue [near-perfect plasma pQTL coloc — OT L2G `pQtlColocClppMaximum` 0.947 / SHAP 0.115, `pQtlColocH4Maximum` 0.99998 / SHAP 0.070] → biases TRAIL / death-receptor signaling toward chronic apoptotic pressure at the RPE–choroid interface [no DE or Reactome rows for this gene in v0 indices; mechanism inferred from canonical DR4 biology and pQTL signal alone] → predisposes to chorioretinal cell loss, with the human genetic signal at this locus pointing more toward central serous chorioretinopathy / polypoidal choroidal vasculopathy than to classic neovascular AMD [`PMC13092188`, `bio_b16bf94e6c0d`].
