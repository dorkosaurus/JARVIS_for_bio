...
NOT regenerated by this script. Re-running this script will preserve the rest
of the report (Summary, Variant consequence, L2G, ESM3, DE, pathway, literature,
and the claude -p-generated "Mechanistic hypothesis" prose at the bottom) but
the "## Hypothesis" block is appended unchanged from disk. v1 will move that
section into a HYPOTHESIS_OVERRIDES constant or generate it via claude -p.
"""
