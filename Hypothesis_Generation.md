...
```
User:  I have a GWAS for AMD, can you do your best to analyze this dataset and formulate hypotheses for how these findings affect AMD disease biology at a cellular level?
Agent:  Looking
[...thinking...]  # 2 minutes pass
Agent:  From this GWAS, I was able to find that variant rs1234 that colocalizes with a rans-pQTL for gene ABC which is a part of the WNT signalling pathway.  I was also able to find single cell evidence that suggests this gene and many others in the WNT signalling pathway are co-expressed and upregulated in RPE cells (retinal pigment epithelial cells) in patients with AMD vs those that do not.  Given this, I was able to form the hypothesis that upregulation of gene ABC leads AMD via upregulation of the WNT signalling pathway in RPE cells.
```
...
4.  Identify gene programs from single expression data where we can find these gene programs.
5.  Perform differential expression between case/controls in this data that enables us to determine if we can find pathways that are differentially expressed between people who have AMD and people who do not.
6.  Form the hypothesis

### Why agents can't perform these tasks right now
...
Each of these tasks requires extensive data preparation and transformation.  The data environment is not set up to enable agents to efficiently perform these tasks.  We need a different approach.
